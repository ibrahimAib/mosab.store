...
if(customers != null ){
    ...
    if(document.getElementById('customer')){
        document.getElementById('customer').innerHTML = '<h3 style="text-align: center; color:red; font-size:20px">لا توجد منتجات</h3>';
    }
}
...
function add_product(){
    ...
    let index = customers.findIndex(item => item.name === add_name.value || item.phone === add_phone.value);
    if(index != -1){
