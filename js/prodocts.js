...
if(products != null ){
    ...
    if(document.getElementById('products')){
        document.getElementById('products').innerHTML = '<h3 style="text-align: center; color:red; font-size:20px">لا توجد منتجات</h3>';
    }
}
...
function add_product(){
    ...
    let index = products.findIndex(item => item.title === add_title.value || item.sn === add_sn.value);
    if(index != -1){
            ...
            for (let i = 0; i < products.length; i++) {
                ...
                <tr>
                    <form id="updateProductForm${products[i]['id']}">
                        ...
                        <td>
                            <button id="save${i}" class="text_intput number_input_small btn-pro btn-update" onclick="updateProductButton(${products[i]['id']},${i})" name="update">
